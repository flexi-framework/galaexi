...
REAL,DEVICE,DIMENSION(PP_nVarEOS),INTENT(IN) :: EOS_Vars
#endif
!----------------------------------------------------------------------------------------------------------------------------------
! LOCAL VARIABLES
INTEGER             :: i
...
#if PARABOLIC
                                                                          ,gradUx,gradUy,gradUz,d_EOS_Vars &
#endif
                                                                          ,f,g,h,Mf,Mg,Mh)
...
CALL EvalDiffFlux3D_CUDA_Kernel<<<nDOF/nThreads+1,nThreads>>>(nDOF,UPrim,gradUx,gradUy,gradUz,f,g,h,d_EOS_Vars)
